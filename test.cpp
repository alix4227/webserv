...
/*La socket server sera prete lorsqu'un client va essayer de se connecter et les sockets clients 
seront pretes lorsqu'un client voudra envoyer un message*/
/*poll() detecte si une socket est prete c'est a dire qu'il va detecter si le socket est en POLLIN et l'indiquer dans revents*/

std::vector<pollfd>poll_fds;
pollfd p1;
p1.fd = socket_server;
p1.events = POLLIN;
poll_fds.pushback(p1);